...
mod read_register_tests {
    ...
    mod immediate_tests {
        ...
        use crate::parser::parser_instruction_tokenization::instruction_tokenization::ErrorType::{ImmediateOutOfBounds, NonIntImmediate};
    ...
    mod memory_address_tests {
        ...
        use crate::parser::parser_instruction_tokenization::instruction_tokenization::ErrorType::{ImmediateOutOfBounds, InvalidMemorySyntax, NonIntImmediate, UnrecognizedRegister};
...
mod confirm_commas_tests {
    use crate::parser::parser_instruction_tokenization::instruction_tokenization::{confirm_commas_in_instruction, Instruction};
...
mod create_vector_of_instructions_tests {
    use crate::parser::parser_instruction_tokenization::instruction_tokenization::{create_vector_of_instructions, Instruction};
