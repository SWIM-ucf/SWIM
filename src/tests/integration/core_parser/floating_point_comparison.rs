...
akin! {
    ...
    //                       150.5                120.125              5.5                  50.125                69.0
    let &value1 =           [1125548032,          1123041280,          1085276160,          1112047616,           1116340224];
    //                       150.5                55.75                6.5                  2.0                   69.5
    let &value2 =           [1125548032,          1113522176,          1087373312,          1073741824,           1116405760];
    let &expected_result =  [1,                   0,                   1,                   0,                    1];
...
akin! {
    ...
    //                       150.5                120.125              5.5                  50.125                69.0
    let &value1 =           [4639499264563609600, 4638153462331211776, 4617878467915022336, 4632251283913310208,  4634555860285128704];
    //                       150.5                55.75                6.5                  2.0                   69.5
