                ...
                <div style="flex-basis: 70%; display: flex; flex-direction: column; align-items: stretch; min-width: 0;">
                    ...
                    <div>
                        <div class="debugger-buttons">
                            <button class="debugger-button" title="Upload file" onclick={upload_clicked_callback}>
                            ...
                            <button class="debugger-button" title="Execute" disabled={true}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="debugger-button" title="Execute Next Stage" id="execute-stage-button" onclick={on_execute_stage_clicked} disabled={false}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="debugger-button" title="Execute Next Instruction" onclick={on_execute_clicked} >
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="debugger-button" title="Pause Execution" disabled={true}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="debugger-button" title="Stop Execution" disabled={true}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="debugger-button" title="Reset Program" id="reset-button" onclick={on_reset_clicked}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="debugger-button" title="Copy to Clipboard" onclick={on_clipboard_clicked}>{"Copy to Clipboard "}<i class="fa-regular fa-copy"></i></button>
                        </div>
                    </div>
