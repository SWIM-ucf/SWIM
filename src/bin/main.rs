...
fn app(props: &AppProps) -> Html {
    ...
    log::debug!("{:?}", datapath_state.mips.executing);
    html! {
        <>
                ...
                <div class="left-column">
                    ...
                    <div>
                        <div class="debugger-buttons">
                            <button class="debugger-button" id="upload-file-btn" title="Upload file" onclick={upload_clicked_callback}>
