        ...
        <>
            ...
            <div class="flex flex-row flex-no-wrap h-screen p-2 gap-2">
                ...
                <div class="flex basis-3/4 flex-col items-stretch min-w-0">
                    // Top buttons
                    <div>
                        <div class="my-0 mx-auto flex flex-row items-center gap-2">
                            ...
                            <button class="group hover:stroke-primary-100 disabled:opacity-30 duration-300" title="Execute" onclick={on_continue_execution} disabled={datapath_state.mips.executing || !datapath_state.mips.initialized}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="disabled:opacity-30 group duration-300" title="Pause Execution" disabled={! datapath_state.mips.executing} onclick={on_pause_execution}>
                                <svg width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="disabled:opacity-30 group duration-300" title="Execute Next Stage" onclick={on_execute_stage_clicked} disabled={!datapath_state.mips.initialized}>
                            ...
                            <button class="hover:stroke-primary-100 disabled:opacity-30 duration-300 group" title="Execute Next Instruction" onclick={on_execute_clicked} disabled={!datapath_state.mips.initialized}>
                                <svg width="38" height="38" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <button class="hover:stroke-primary-100 disabled:opacity-30 duration-300 group" title="Reset Program" onclick={on_reset_clicked} disabled={!datapath_state.mips.initialized}>
                                <svg width="38" height="38" viewBox="0 0 38 38" xmlns="http://www.w3.org/2000/svg">
